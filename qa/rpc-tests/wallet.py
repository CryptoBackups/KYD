...
#   c) node1 mines 32 blocks, so now node 0 has 500000RLT, node 1 has 4250RLT, node2 has none.
#   d) node0 sends 601 RLT to node2, in two transactions (301 RLT, then 300 RLT).
