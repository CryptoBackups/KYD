...
RESOURCES += src/qt/realtime.qrc src/qt/realtime_locale.qrc

TRANSLATIONS += src/qt/locale/realtime_bg.ts \
                src/qt/locale/realtime_de.ts \
                src/qt/locale/realtime_en.ts \
                src/qt/locale/realtime_es.ts \
                src/qt/locale/realtime_fi.ts \
                src/qt/locale/realtime_fr.ts \
                src/qt/locale/realtime_it.ts \
                src/qt/locale/realtime_ja.ts \
                src/qt/locale/realtime_pl.ts \
                src/qt/locale/realtime_pt.ts \
                src/qt/locale/realtime_ru.ts \
                src/qt/locale/realtime_sk.ts \
                src/qt/locale/realtime_sv.ts \
                src/qt/locale/realtime_vi.ts \
                src/qt/locale/realtime_zh_CN.ts \
                src/qt/locale/realtime_zh_TW.ts
