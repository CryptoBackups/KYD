Contributing to Realtime Core
==================================

The Realtime Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Realtime Core project, and is not to be
confused with overall Realtime Network Protocol consensus changes.

Whether a pull request is merged into Realtime Core rests with the project merge
...
Patches that change Realtime consensus rules are considerably more involved than
...
Where a patch set proposes to change the Realtime consensus, it must have been
...
The project leader is the release manager for each Realtime Core release.
