Contributing to KYD Core
==================================

The KYD Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KYD Core project, and is not to be
confused with overall KYD Network Protocol consensus changes.

Whether a pull request is merged into KYD Core rests with the project merge
...
Patches that change KYD consensus rules are considerably more involved than
...
Where a patch set proposes to change the KYD consensus, it must have been
...
The project leader is the release manager for each KYD Core release.
