...
In order to support loading of multiple wallets in realtime-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is realtime.cpp.
...
Changes to realtime.cpp
----------------------
realtime.cpp is the entry point into realtime-qt, and as such, will require some minor modifications to provide hooks for
