...
In order to support loading of multiple wallets in kydcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kydcoin.cpp.
...
Changes to kydcoin.cpp
----------------------
kydcoin.cpp is the entry point into kydcoin-qt, and as such, will require some minor modifications to provide hooks for
