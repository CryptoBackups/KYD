...
This mechanism has been integrated into Bitcore-Node-Realtime which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/realtime/insight-api-realtime#web-socket-api](https://github.com/realtime/insight-api-realtime#web-socket-api)
* API: [https://github.com/realtime/insight-api-realtime#swifttx-transactions](https://github.com/realtime/insight-api-realtime#swifttx-transactions)
...
By default, the Realtime Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Realtime Core daemon:
