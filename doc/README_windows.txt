...
Intro
-----
Realtime (RLT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Realtime utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run realtime-qt.exe.

Realtime Core is the original Realtime client and it builds the backbone of the network.
However, it downloads and stores the entire history of Realtime transactions;
