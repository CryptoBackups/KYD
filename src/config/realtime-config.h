/* src/config/realtime-config.h.  Generated from realtime-config.h.in by configure.  */
/* src/config/realtime-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Realtime Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Realtime Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "realtime"
