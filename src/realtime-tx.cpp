...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Realtime Core realtime-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  realtime-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded realtime transaction") + "\n" +
                               "  realtime-tx [options] -create [commands]   " + _("Create hex-encoded realtime transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded realtime transaction
