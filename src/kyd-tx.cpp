...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KYD Core kydcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kydcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kydcoin transaction") + "\n" +
                               "  kydcoin-tx [options] -create [commands]   " + _("Create hex-encoded kydcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kydcoin transaction
