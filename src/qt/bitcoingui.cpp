                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KYD Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KYD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kydcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KYD Core"), this);
    aboutAction->setStatusTip(tr("Show information about KYD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KYD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KYD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KYD addresses"));
    ...
    openAction->setStatusTip(tr("Open a kydcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KYD Core help message to get a list with possible KYD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KYD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KYD network", "", count));
}
...
{
    QString strTitle = tr("KYD Core"); // default title
