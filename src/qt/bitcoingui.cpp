                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Realtime Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RLT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and realtime: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Realtime Core"), this);
    aboutAction->setStatusTip(tr("Show information about Realtime Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Realtime"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RLT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RLT addresses"));
    ...
    openAction->setStatusTip(tr("Open a realtime: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Realtime Core help message to get a list with possible Realtime command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Realtime Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Realtime network", "", count));
}
...
{
    QString strTitle = tr("Realtime Core"); // default title
