...
/** Utility functions used by the Realtime Qt UI.
 */
namespace GUIUtil
{
...
// Render RLT addresses in monospace font
...
// Parse "realtime:" URI into recipient object, return true on successful parsing
