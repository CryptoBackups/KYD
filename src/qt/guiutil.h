...
/** Utility functions used by the KYD Qt UI.
 */
namespace GUIUtil
{
...
// Render KYD addresses in monospace font
...
// Parse "kydcoin:" URI into recipient object, return true on successful parsing
