...
// Copyright (c) 2017 The KYD developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000017eae7021fcaad4a07f4b0cef052105843f1f02ff65ee99437d97d44000"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1530718541, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // KYD: 1 minute blocks
        ...
        nLastPOWBlock = 210;
        nModifierUpdateBlock = 1; // we use the version 2 for KYD

        /*
         * python ~/genesis.py -a quark-hash -z "KYD chain is alive" -t 1530718541 -v 0 -p 04f5a8143f86ad8ac63791fbbdb8e0b91a8da88c8c693a95f6c2c13c063ea790f7960b8025a9047a7bc671d5cfe707a2dd2e13b86182e1064a0eea7bf863636363 -n 21561600 -b 0x1e0ffff0

         */

        const char* pszTimestamp = "KYD chain is alive";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530718541;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 25052435;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000017eae7021fcaad4a07f4b0cef052105843f1f02ff65ee99437d97d44000"));
        ...
        // KYD addresses start with 'K'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 45);
        // KYD script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // KYD private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // KYD BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // KYD BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // KYD BIP44 coin type is '222' (0x800000de)
        ...
        strSporkKey = "02aa653a1d1db8310f1f48499df2035cbfa47e44d00e1679e216ef383c85c380e3";
         nEnforceNewSporkKey = 1535734116; //!> Sporks signed after August 31, 2018 4:48:36 PM GMT must use the new spork key
        nRejectOldSporkKey = 1535647716; //!> Reject old spork key after Thursday, August 30, 2018 4:48:36 PM GMT
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // KYD: 1 minute
        nLastPOWBlock = 1500;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet KYD addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet KYD script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet KYD BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet KYD BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 2 * 60;        // KYD: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
